        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              ...
              {/* Ena quick-open chat button */}
              <div className="animate-fade-in-up delay-300">
                <button
                  onClick={() => window.openEnaChat && window.openEnaChat()}
                  className="w-full mt-2 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-border bg-primary/5 text-sm font-medium text-primary hover:bg-primary/10"
                  title="Open Ena Chat"
                >
